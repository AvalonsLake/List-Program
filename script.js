...
function addProduct() {
  ...
  if (input === "") {
    alert("You can't have an empty input, please input something");
    return false;
  }
  ...
  // Assignment 3:
  // Hint: Use a loop(look up the javascript loop on w3schools.) on your product array and
  // set the max length of the loop to the array using
  ...
  for (let i = 0; i < productArray.length; i++) {
    ...
    list.textContent = `${productArray[i].input}`;
